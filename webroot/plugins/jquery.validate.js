...
$.extend($.validator, {
	...
	messages: {
		...
		number: "Por favor digite um numero válido.",
		digits: "Por favor digite apenas números.",
		creditcard: "Por favor digite um numero de cartão de crédito válido.",
		equalTo: "Por favor indique o mesmo valor novamente.",
		accept: "Por favor digite uma valor com uma extensão válida.",
		maxlength: $.validator.format("Por favor o texto não deve conter mais que {0} characters."),
		minlength: $.validator.format("Por favor digite no minimo {0} caracteres."),
		rangelength: $.validator.format("Por favor digite um valor com a quantidade de caracteres entre {0} e {1}."),
