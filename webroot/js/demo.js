$(document).ready(function() {
    ...
    /*$("input[type='checkbox'][name='_discart']").each(function(i, o) {
        // adiciona um evento
        $(this).click(function() {
            // Define o atributo 'checked' dos campos em relação ao checkbox 'chave'
            $(".mws-table").find("input[type='checkbox']").attr("checked", this.checked ? "true" : "false");
        });

        // Adiciona nos demais checkbox um evento para quando um deles
        // for selecionado, verificar se o checkbox 'chave' deve ser
        // selecionado ou não.
        $(".mws-table").find("input[type='checkbox'][name!='_discart']").click(function() {
            var total_checkbox     = $(this).parent().find("input[type='checkbox'][name!='_discart']").length;
            var total_selecionados = $(this).parent().find("input[type='checkbox'][name!='_discart']:checked").length

            $(".mws-table").find("input[type='checkbox'][name='_discart']").attr("checked", total_checkbox == total_selecionados ? "checked" : "");
        });
    });*/
    
    $("input[type='checkbox'][name='_all']").change(function() {
        var chs = $(".mws-table").find("input[type='checkbox'][name!='_discart']").get();
        $(chs).each(function(i, o){
            chs[i].checked = $("input[type='checkbox'][name='_all']").attr("checked");
        });
    });
